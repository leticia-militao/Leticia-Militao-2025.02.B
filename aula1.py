...
nota1 = float.text_input("Informe a primeira nota: ")
nota2 = float.text_input("Informe a segunda nota: ")
nota3 = float.text_input("Informe a terceira nota: ")
nota4 = float.text_input("Informe a quarta nota: ")
